...
target_image_path = 'test_pictures/people/4.jpg'
style_reference_image_path = 'all_styles/su_miao/4.jpg'
...
loss += content_weight * content_loss(base=target_image_features, combination=combination_features)
